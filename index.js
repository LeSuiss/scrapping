...
app.listen(3000, () => {
    ...
    const requesting = (query)=>axios.post('https://api.sorare.com/graphql', {
Host: 'api.sorare.com',
...
,"query":query.query,
    ...
    .catch(y=>console.log(y))
     ...
     //requesting(queries.configQuery)
     requesting(queries.IngameNotificationQuery)
     requesting(queries.cardsQuery)
    });
